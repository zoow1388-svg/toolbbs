[CmdletBinding()]
param(
    [Parameter(Mandatory=$true)][ValidateSet('initialize','register','transition','prepare-dispatch','record-sent','record-observation','record-wait','record-ack','record-result','verify-result','reconcile','show','audit')][string]$Action,
